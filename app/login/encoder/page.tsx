...
export default function EncoderLoginPage() {
  return (
      ...
      <section className="w-full max-w-md rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Barangay Census and Data Encoding System
          </p>
        </div>

        <LoginFormSandbox
          idLabel="Encoder ID"
          idHint="Use the assigned Barangay encoder identifier."
          dashboardRoute="/dashboard/encoder"
        />
      </section>
    </main>
  );
